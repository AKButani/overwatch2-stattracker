        ...
        <div>
            <div className="bookmark-container">
                {bookmarks.map(([playerName, icon, namecard]) => (
                    <SingleBookmark key={playerName} playerName={playerName as string} playerIcon={icon as string} playerNamecard={namecard as string} onSearch={props.onSearch} setSearchTerm={props.setSearchTerm}/>
                ))
                }
            </div>
        </div>
